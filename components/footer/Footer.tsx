...
const Footer = () => {
  ...
  const liClassNames = " hover:text-commonColor hover:translate-x-3 transition-all duration-300 ease-in-out"
    ...
    <div className=" bg-slate-100 py-20 px-4">
      <div className=" container mx-auto grid md:grid-cols-4 gap-10 ">
        ...
        <div>
          ...
          <p className=" text-justify ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti inventore iure quia voluptatem expedita in doloremque repudiandae dolore, nam, rem officia labore, eum dolorum? Perspiciatis debitis ullam fugiat sit. Laborum!</p>
        </div>
